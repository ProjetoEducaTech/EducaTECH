...
<body>
	...
	<div>
		...
		<label for="email">E-mail</label>
			<input type="email" id="input-mail" name="email" value="<c:out value='${contato.email}'/>" placeholder="Digite seu e-mail" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" maxlength="100" required>
