	...
	<div>
		...
		<label for="senha">E-mail</label>
      	...
      	<label for="celular">Celular</label>
			<input type="tel" id="input-celular" placeholder="(xx) xxxxx-xxxx" value="<c:out value='${contato.celular}'/>" min="15" max="15" pattern="\([0-9]{2}\)[\s][0-9]{5}-[0-9]{4}" required>
		<label for="telefone">Telefone</label>
			<input type="tel" id="input-telefone" placeholder="(xx) xxxx-xxxx" value="<c:out value='${contato.telefone}' />" min="15" max="15" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4}" required>
