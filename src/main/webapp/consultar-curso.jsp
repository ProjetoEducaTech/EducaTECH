...
<body>
	...
	<form action="consultar-curso" method="post">
		...
		<div class="container-field">
			...
			</select> <label>Nota de Corte<em>*</em></label> <input type="text"
				name="notaCorte"> <label>Turno<em>*</em></label> <select
				name="turno">
			...
			<label>Preço</label> 
			<input type="range" min="${precoMinimo}" max="${precoMaximo}" value="50" name="preco"> 
			...
			</select> <label>Preço</label> <input type="range" min="${precoMinimo}"
				max="${precoMaximo}" value="${precoMinimo}" name="preco"> <label>Duracao<em>*</em></label>
			<input type="text" name="duracao"> <label>Área<em>*</em></label>
			...
			<label>Instituições<em>*</em></label> 
			
			<select name="instituicao">

			</select> <label>Instituições<em>*</em></label> <select name="instituicao">
