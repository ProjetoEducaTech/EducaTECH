...
public class AlunoDAOImpl implements AlunoDAO {
	 ...
	 * 
	 * Session sessao = null; List<Curso> consultaNota = null;
	 * 
	 * try {
	 * 
	 ...
	 * 
	 * ParameterExpression<Double> notaCorteAluno =
	 * construtor.parameter(double.class);
	 * criteria.where(construtor.equal(juncaoNota.get(Aluno_.NOTACORTE),
	 * notaCorteAluno));
	 * 
	 * consultaNota = sessao.createQuery(criteria).setParameter(notaCorteAluno,
	 * aluno.getNotaCorte()).getResultList();
	 * 
	 * sessao.getTransaction().commit();
	 * 
	 * } catch (Exception sqlException) {
	 ...
	 * 
	 * Session sessao = null; List<Curso> consultaInstituicao = null;
	 * 
	 * try {
	 * 
	 * sessao = conectarBanco().openSession(); sessao.beginTransaction();
	 ...
	 * Root<Curso> raizCurso = criteria.from(Curso.class);
	 * 
	 * Join<Curso, Instituicao> juncaoInstituicao =
	 * raizCurso.join(Curso_.instituicao);
	 * 
	 * ParameterExpression<String> cnpfinstituicao =
	 * construtor.parameter(String.class);
	 * criteria.where(construtor.equal(juncaoInstituicao.get(Instituicao_.CNPJ),
	 * cnpfinstituicao));
	 * 
	 * consultaInstituicao =
	 * sessao.createQuery(criteria).setParameter(cnpfinstituicao,
	 * instituicao.getCnpj()).getResultList();
	 * 
	 * sessao.getTransaction().commit();
	 * 
	 * } catch (Exception sqlException) {
	 ...
	 * 
	 * Session sessao = null; List<Curso> consultaArea = null;
	 * 
	 * try {
	 * 
	 * sessao = conectarBanco().openSession(); sessao.beginTransaction();
	 ...
	 * 
	 * ParameterExpression<String> cnpjinstituicao =
	 * construtor.parameter(String.class);
	 * criteria.where(construtor.equal(juncaoArea.get(Area_.NOME),
	 * cnpjinstituicao));
	 * 
	 * consultaArea = sessao.createQuery(criteria).setParameter(cnpjinstituicao,
	 * area.getNome()).getResultList();
	 * 
	 * sessao.getTransaction().commit();
	 * 
	 * } catch (Exception sqlException) {
